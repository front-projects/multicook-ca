        ...
        <footer className="footer">
                        ...
                        <dd className="footer-block__list">
                            <ul className="footer-list">
                                ...
                                <li>
                                    ...
                                    >Potato fritters (deruny) and Potato zrazy</Link
                                    >
                                </li>
                                <li>
                                    <Link
                            ...
                            <ul className="footer-list">
                                ...
                                <li>
                                    ...
                                    >Cabbage rolls and Stuffed peppers</Link
                                    >
                                </li>
                                <li>
                                    <Link
            ...
            <div className="copyright">
                ...
                >
                    <svg>
                        <use
                            xlinkHref="images/gigaprog-logo-white.svg#gigaprog-logo-white"
                        ></use>
                    </svg>
                </Link>
                ©
