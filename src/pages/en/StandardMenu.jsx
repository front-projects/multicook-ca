        ...
        <div className="container">
          ...
          {/* <div className="menu-page__premium">
            ...
            <div className="menu-page__content menu-page__content--higher">
              <a
                href="https://multicook-franchise.com/en/menu/chef-menu"
                className="product"
              >
                <img
                  src="images/rm2651nPFIL1XId33gKqcmNcVI0D5RTA0daUu6ld_res600x600_opt.jpg"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/pizza-and-sushi"
                className="product"
              >
                <img
                  src="images/1c8QtYVh6dv4lClB9BRoxqPdpTDxGESg64dywLYY_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/ice-cream"
                className="product"
              >
                <img
                  src="images/kPYqMZlnZ7LzOd43F11sZrcsBuJnnpxXNifbAT0P_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/confectionery"
                className="product"
              >
                <img
                  src="images/bhB4uTgTHGkot5nH1AWKzjS1hiPQqcx949x0vZ0X_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/nacionalni-stravi"
                className="product"
              >
                <img
                  src="images/ZJc79kilQYsQkAqG5g8jX6N9NsckOHkd094TjhFp_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/meniu-bez-svinnogo-sala"
                className="product"
              >
                <img
                  src="images/8wNmYLnnvI3YhQlr2vKmqH4a9tmdDoAz9mOlTErX_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/napoyi"
                className="product"
              >
                <img
                  src="images/uD1nOZNHw9qQqG4DlvK7oGwynFNJTtOWVFzM6KCc_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
              ...
              <a
                href="https://multicook-franchise.com/en/menu/sousa"
                className="product"
              >
                <img
                  src="images/5RknVr9fXOFgcOqWnRTplfvrt2uDdCYG3GL9tczB_res600x600_opt.jpg"
                  className="product__img"
                  alt="Panckes"
                  width="1"
                  height="1"
